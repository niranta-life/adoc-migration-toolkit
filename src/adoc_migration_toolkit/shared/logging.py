            ...
            if os.path.exists(rotated_file):
                try:
                    ...
                    logging.getLogger(__name__).warning(
                        f"Could not set rotated log file to read-only: {e}"
                    )


def setup_logging(
    verbose: bool = False, log_level: str = "INFO", log_file_path: str = None
) -> logging.Logger:
    ...
    logging.basicConfig(level=actual_level, handlers=handlers, force=True)
