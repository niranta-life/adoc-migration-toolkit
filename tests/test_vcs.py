...
class TestVCSOperations:
    ...
    def test_is_valid_remote_url_https(self):
        ...
        assert is_valid_remote_url("https://enterprise.gitlab.com/user/repo.git") is True
    ...
    def test_determine_auth_method_unknown(self):
        ...
        assert determine_auth_method("ftp://github.com/user/repo.git") == "https"  # defaults to https
