...
def sample_json_data():
    ...
    return {
        ...
        "backingAssets": [{"uid": "asset-1-PROD_DB"}, {"uid": "asset-2-PROD_DB"}],
    }
...
def sample_policy_data():
    ...
    return [
        ...
        },
        {
            ...
            "isSegmented": True,
            "engineType": "JDBC_SQL",
            "backingAssets": [{"uid": "asset-jdbc-1-PROD_DB"}],
        },
        {
            "name": "non_segmented_policy",
            "isSegmented": False,
            "engineType": "SPARK",
            "backingAssets": [{"uid": "asset-non-seg-1-PROD_DB"}],
        },
    ]
...
class TestPolicyExportFormatter:
    ...
    def test_init_with_valid_parameters(self, temp_dir):
        ...
        formatter = PolicyExportFormatter(
            input_dir=str(temp_dir), string_transforms={"PROD_DB": "DEV_DB"}
        )
    ...
    def test_init_with_empty_input_dir(self):
        ...
        with pytest.raises(ValueError, match="Input directory cannot be empty"):
            PolicyExportFormatter(input_dir="", string_transforms={"PROD_DB": "DEV_DB"})
    ...
    def test_init_with_empty_string_transforms(self, temp_dir):
        ...
        with pytest.raises(
            ...
            PolicyExportFormatter(input_dir=str(temp_dir), string_transforms={})
    ...
    def test_init_with_invalid_string_transforms(self, temp_dir):
        ...
        with pytest.raises(
            ...
            PolicyExportFormatter(input_dir=str(temp_dir), string_transforms=None)
    ...
    def test_init_with_file_as_input_dir(self, temp_dir):
        ...
        with pytest.raises(ValueError, match="Input path is not a directory"):
            PolicyExportFormatter(
                input_dir=str(test_file), string_transforms={"PROD_DB": "DEV_DB"}
            )
    ...
    def test_replace_in_value_dict(self, temp_dir):
        ...
        input_dict = {
            "name": "test",
            "database": "PROD_DB.users",
            "nested": {"query": "SELECT * FROM PROD_DB.users"},
        }
        ...
        expected = {
            ...
            "nested": {"query": "SELECT * FROM DEV_DB.users"},
        }
    ...
    def test_extract_data_quality_assets_single_policy(self, temp_dir):
        ...
        single_policy = {
            ...
            "isSegmented": True,
            "engineType": "SPARK",
            "backingAssets": [{"uid": "single-asset-PROD_DB"}],
        }
    ...
    def test_process_json_file_success(self, temp_dir, sample_json_data):
        ...
        formatter = PolicyExportFormatter(
            input_dir=str(resolved_temp_dir), string_transforms={"PROD_DB": "DEV_DB"}
        )
        ...
        assert (
            output_data["config"]["query"]
            == "SELECT * FROM DEV_DB.users WHERE active = true"
        )

    def test_process_json_file_with_data_quality_policies(
        self, temp_dir, sample_policy_data
    ):
...
class TestParseFormatterCommand:
    ...
    def test_parse_formatter_command_valid(self):
        ...
        input_dir, string_transforms, output_dir, quiet_mode, verbose_mode = (
    ...
    def test_parse_formatter_command_with_input_dir(self):
        ...
        command = (
            'policy-xfr --input /path/to/input --string-transform "PROD_DB":"DEV_DB"'
        )
...
class TestExecuteFormatter:
    ...
    def test_execute_formatter_with_global_output_dir(self, temp_dir, mock_logger):
        ...
        with patch(
            "src.adoc_migration_toolkit.execution.formatter.globals.GLOBAL_OUTPUT_DIR",
            global_output_dir,
        ):
            execute_formatter(
                input_dir=None,
