...
'''
    ...
    def build(self, onefile: bool = True, console: bool = True, create_wrapper: bool = True) -> bool:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Build ADOC Migration Toolkit with PyInstaller")
    ...
    parser.add_argument("--no-wrapper", action="store_true",
                       help="Skip creating wrapper script")
